import imgBangqiumao from '@/assets/baseball-cap.png';
import imgYufumao from '@/assets/bucket-hat.jpeg';
import imgBeilei from '@/assets/beret.png';
import imgZhenzhi from '@/assets/knit-hat.png';
import imgBaisechenshan from '@/assets/white-shirt.png';
import imgTiaowenT from '@/assets/striped-tee.png';
import imgZhenzhimaoyi from '@/assets/knit-sweater.png';
import imgWeiyi from '@/assets/hoodie.png';
import imgSuihuachenshan from '@/assets/floral-shirt.png';
import imgBaizhequn from '@/assets/pleated-skirt.png';
import imgAziqun from '@/assets/a-line-skirt.png';
import imgSuihuachangqun from '@/assets/floral-dress.png';
import imgNiuzaiku from '@/assets/jeans.png';
import imgXiuxianku from '@/assets/casual-pants.png';
import imgYundongku from '@/assets/sport-pants.png';
import imgZhenzhuXianglian from '@/assets/pearl-necklace.png';
import imgShoulian from '@/assets/bracelet.png';
import imgErhuan from '@/assets/earrings.png';
import imgMojing from '@/assets/sunglasses.png';
import imgYundongneiyi from '@/assets/sports-bra.jpeg';
